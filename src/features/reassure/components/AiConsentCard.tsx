  ...
  return (
    <View
      ...
      <Text
        ...
        If you turn this on, a small, minimized summary of your baby’s logs — just counts (feeds,
        diaper changes, spit-ups, longest sleep) and a rough age range — is sent to our AI provider
        to word the short read above. Your notes, the exact things you type or say, and your
        pediatrician’s number are never sent.
      </Text>
      <Text
        style={{
